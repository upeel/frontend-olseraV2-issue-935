  ...
  <div>
    <div class="summary">
      ...
      <el-table :data="summary" border>
        ...
        <el-table-column min-width="140px" :label="lang.qty" prop="ftotal_qty" />
      </el-table>
    </div>
    ...
    <el-table :data="data" border>
      <el-table-column :label="lang.order_no" prop="order_no" min-width="180px" >
        <template slot-scope="scope">
          ...
          <router-link
            v-else
            :to="{path: '/sales/openorder/' + scope.row.id,query: {'rpt': true, 'path': 'salesitemaddonsbydateshift'}}">
            {{ scope.row.order_no }}
          </router-link>
        </template>
      </el-table-column>
      ...
      <el-table-column :label="lang.qty" prop="forder_qty" />
      <el-table-column min-width="140px" :label="lang.sales_amount" prop="ftotal_amount" />
    </el-table>
...
<script>
export default {
  name: 'TableSalesitemaddonsbydateshift',
