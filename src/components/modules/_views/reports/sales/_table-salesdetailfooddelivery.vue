  ...
  <div>
    ...
    <bs-table
      :header="[
        ...
        lang.customer,
        lang.sales_amount,
        $lang[langId].subtotal_net,
        $lang[langId].food_delivery_fee,
        lang.shipping + '+' + lang.tax,
        $lang[langId].total_amount_net,
        lang.discount
      ]">
      <tr
        ...
        <td>{{ item.ftotal_amount }}</td>
        <td>{{ item.ftotal_amount_original }}</td>
        <td>{{ item.ffood_delivery_fee }}</td>
        <td>{{ item.fshipping_tax_amount }}</td>
        <td>{{ item.ftotal_order_amount_original }}</td>
