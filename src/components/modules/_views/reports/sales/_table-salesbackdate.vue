  ...
  <div>
    <div class="summary">
      ...
      <bs-table
        ...
        <tr
          ...
          <td>{{ item.ftotal_redeemed_amount }}</td>
        </tr>
      </bs-table>
    </div>
    ...
    <bs-table
      ...
      <tr
        ...
        <td class="text-right">{{ item.fredeemed_amount }}</td>
