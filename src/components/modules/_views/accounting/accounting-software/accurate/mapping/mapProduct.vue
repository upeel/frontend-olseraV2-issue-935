    ...
    <div class="title-jurnal">
      <h4>
        ...
        <div style="float: right;">
          ...
          <el-button type="primary" size="small" @click="showMappedProduct">
            {{lang.all_products}}
          </el-button>
...
import { listFecthProduct } from '@/api/accounting-3rd/accurate'
...
export default {
  ...
  mounted() {
    // if(this.isFecth.fetchProduct === 0){
      this.loadProductAccurate()
    // }
  }
}
