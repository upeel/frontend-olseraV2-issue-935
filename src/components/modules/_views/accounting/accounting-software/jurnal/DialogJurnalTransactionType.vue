      ...
      custom-class="dialog-card">
          ...
          <el-row :gutter="20"  style="width: 100%">
            <el-col :span="14">
              <h4 class="dialog-title" align="left">
                <strong v-if="activeTab === 'revenue'">{{$lang[langId].set_income_transaction_type}}</strong>
        ...
        <!-- <el-row :gutter="10" class="pb-12">
          <el-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24" align="left">
            <el-button @click="secletAccountTab('revenue')" :type="activeTab === 'revenue' ? 'primary' : 'info'" round plain size="small">{{$lang[langId].revenue}}</el-button>
        ...
        <map-income v-if="activeTab === 'revenue'"/>
...
<script>
import mapIncome from 'components/modules/_views/accounting/accounting-software/jurnal/mapping/mapIncome.vue';
import mapExpense from 'components/modules/_views/accounting/accounting-software/jurnal/mapping/mapExpense.vue';
