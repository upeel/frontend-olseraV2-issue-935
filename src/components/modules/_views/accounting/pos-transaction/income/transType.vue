	...
	<el-dialog
		...
		<div slot="title" class="flex-container">
			<el-row :gutter="20"  style="width: 100%">
				<el-col :span="14">
					<h4 class="font-semi-bold" align="left">{{rootLang.income_transaction_type}}</h4>
				</el-col>
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-select filterable 
								...
								style="width: 100%">
								<el-option
									v-for="(item, keyAccount) in dataRevenue"
									:key="keyAccount"
...
import { incomeTypeList, TrxTypePost, revenueOnly} from '@/api/accounting/pos-transaction';
import Loading from 'vue-loading-overlay';
var moment = require('moment');

export default {
  name: 'DialogIncomeTransType',
	props: ['show'],
  ...
  methods: {
    ...
    getRevenue() {
      revenueOnly(this.params).then(response => {
    ...
    getIncomeTrx(){
      ...
      incomeTypeList(this.params).then(response => {
