      ...
      <el-card class="box-card pos-relative">
        <div class="card-body">
          ...
          <div class="row with-padding-left">
            <div class="col-md-9">
              <small style="color: #ccc;">{{$lang[langId].payable}}</small>
          ...
          <el-row :gutter="20"  style="width: 100%">
            ...
            <el-col :span="10" align="right">
              <div class="btn_accounting_dialog">
                ...
                <el-button type="success" :disabled="loadingEdit" @click="handleUpdateJurnal">{{ lang.update }}</el-button>
              </div>
            </el-col>
          </el-row>
        </div>
          ...
          <el-form @submit.native.prevent>
            ...
            <el-form-item>
              <el-select 
                ...
                v-model="formEditJurnal.supplier_id"
                :value="formEditJurnal.supplier_id"
        ...
        <span slot="footer" class="dialog-footer">
          <el-row :gutter="20" style="padding: 0 12px 0 12px;">
            ...
            <el-col :xs="24" :sm="16" :md="16" :lg="16" :xl="16" style="text-align: right;">
              ...
              <el-button type="danger" @click="handleDelete" :disabled="loadingDelete">{{ lang.remove }}</el-button>
            </el-col>
          </el-row>
        </span>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    loadData(){
      ...
      axios({
        method: 'GET',
        url: baseApi(this.selectedStore.url_id, this.langId, 'account/payble/' + id),
        headers: headers,
        params: {
    ...
    selectSupplier (val){
      ...
      this.formEditJurnal.supplier_id = selected.id
    ...
    handleUpdateJurnal () {
      ...
      let data = {
        ...
        supplier_id: this.formEditJurnal.supplier_id,
    ...
    backHandle() {
      ...
      this.$router.push({name: 'Payable', params: {lastParams: lastParams, lastStatus: lastStatus, lastFilter: lastFilter}})
    },
