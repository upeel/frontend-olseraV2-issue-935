    ...
    <div v-else-if="isSetup === 'true'">
      <el-card class="box-card" shadow="never">
        <div slot="header" class="table-handler-flex">
          <h4 style="flex-grow: 1;">{{ lang.customer}} {{lang.due_date}}</h4>
    ...
    <el-dialog
      ...
      <div slot="title" class="flex-container" style="text-align: center">
        <el-row :gutter="20"  style="width: 100%">
          <el-col :span="14">
            <h4 class="dialog-title" style="padding-left: 5%; text-align: left;"> {{capitalize(setPayment.customer_name)}} {{$lang[langId].due_date}}</h4>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    getDueDate() {
      ...
      axios({
        method: 'GET',
        url: baseApi(this.selectedStore.url_id, this.langId, 'account/customerduedate'),
        headers: headers,
        params: this.params
      }).then(response => {
