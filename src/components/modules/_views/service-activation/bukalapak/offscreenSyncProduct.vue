...
import { searchProduct, pairProductBukalapak } from '@/api/thirdParty/bukalapak'
...
export default {
  ...
  methods: {
    ...
    syncProduct () {
      let data = {
        product_id: this.formEdit.id ? this.formEdit.id : this.formEdit.product_id_shopee,
        // product_id: this.formEdit.product_id_shopee,
      ...
      pairProductBukalapak(data).then(response => {
        this.$message({
          type: 'success',
