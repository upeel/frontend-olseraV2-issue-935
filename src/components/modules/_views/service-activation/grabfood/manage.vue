  ...
  <div class="innerpage-fullscreen">
    ...
    <div
      ...
      <div class="flex-container flex-container--content-space-between mb-12">
        ...
        <div class="color-info font-12 pointer" @click="visibleLogs = true">
            ...
            <div class="like-table-wrapper mb-24">
              ...
              :class="item.is_available === 1 && menu.is_available === 1 ? 'flex-container like-table-wrapper--item' : 'flex-container like-table-wrapper--item color-grey--bg img-grey'">
                <div class="full-width flex-container">
                  <!-- <div v-if="menu.detail.photos && menu.detail.photos.length" class="mr-8">
                    <div>
                      <el-avatar
                        :src="menu.photos[0].file_photo"
                        :size="40"
                        shape="square"
                      />
                    </div>
    ...
    <div class="floating_div" style="padding-right: 10vw; padding-left: 10vw">
...
import { 
  ...
  updateMenuBatch,
  updateGrab,
  getUpdateLogs } from '@/api/thirdParty/grabfood'
