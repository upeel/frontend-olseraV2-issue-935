...
import { searchProduct, pairProductLazada } from '@/api/thirdParty/lazada'
...
export default {
  ...
  methods: {
    ...
    syncProduct () {
      let data = {
        product_id_lazada: this.formEdit.product_id ? this.formEdit.product_id : this.formEdit.product_id_lazada,
