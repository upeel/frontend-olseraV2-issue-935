    ...
    <div
            ...
            <div class="flex-container full-width">
              <div class="mr-8 flex-container full-width" @click="handleEdit(item)">
                ...
                <div class="font-bold font-14 ml-8 word-break">
                  ...
                  <div class="font-12">{{ item.price }}</div>
                </div>
              </div>
              ...
              <div>
                <div v-if="item.lazada_primary_category_id !== null" class="mr-8"><el-checkbox v-model="item.checked" @change="handleCheck(item, idx)"></el-checkbox></div>
                <div v-else>
      ...
      <el-dialog
        ...
        <div slot="title" class="flex-container">
          ...
          <template>
            ...
            <el-button type="lazada" :loading="loadingPreUpload" @click="handleSaveSingleProduct">{{ lang.save }}</el-button>
          </template>
        </div>
        <div>
          ...
          <div class="flex-container flex-container--start">
            ...
            <div class="full-width">
              ...
              <el-input v-model="tempItem.SellerSku" maxlength="8" @input="handleChange">
          ...
          <div class="flex-container mt-8">
            <div class="full-width pr-4">
              ...
              <el-input v-model="tempItem.quantity" />
            </div>
            <div class="full-width pl-4">
              <div class="font-12">{{ lang.weight }}</div>
              <el-input v-model="tempItem.package_weight" />
            </div>
          </div>
          ...
          <div v-loading="loadingRequired" class="mt-24">
            <div class="font-12">Kategory Lazada</div>
            <el-autocomplete
      ...
      <el-dialog
        ...
        <div slot="title" class="text-center">
          ...
          <div class="word-break" style="font-weight: normal">2 produk tidak dapat diduplikasi ke Lazada. Produk di Olsera harus memiliki minimal data-data di bawah ini</div>
        </div>
        <div>
...
import { fetchCategoryLazada, 
  ...
  saveBulkStore,
  updatePreUpload } from '@/api/thirdParty/lazada'
export default {
  ...
  methods: {
    ...
    handleEdit (item) {
      ...
      if (item.lazada_attributes !== null && item.lazada_primary_category_id !== null) {
        this.isEdit = true
        let temp = [ ...item.lazada_attributes]
        let params = {
          primary_category_id_lazada: item.lazada_primary_category_id
        }
    ...
    getCategorySearch(queryString, callback) {
      ...
      fetchCategoryLazada(params).then(response => {
    ...
    handleSaveSingleProduct () {
      ...
      let data = {
        ...
        product_sku: this.tempItem.SellerSku,
        ...
        meta: {
          primary_category_id: this.tempItem.lazada_primary_category_id,
        }
      }
    ...
    handleCheck (item, idx) {
      ...
      if (item.lazada_primary_category_id === null) {
        this.$notify({
          type: 'warning',
        ...
        if (exist) {
          ...
          if (item.lazada_primary_category_id !== null && this.dataChecked.length < 20) {
