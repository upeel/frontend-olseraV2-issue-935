    ...
    <div
      ...
      <div class="offscreen-right-sidebar--wrapper">
        ...
        <!-- <div v-loading="loadingStatus" class="px-24">
          <div class="border border--grey-border radius-10 p-8 flex-container">
            <div class="full-width">
              <label>Status Produk (Shopee)</label>
            </div>
      ...
      <el-dialog
        ...
        <div slot="title" class="flex-container">
          ...
          <template>
            ...
            <el-button type="lazada" :loading="loadingUpdateStock" @click="updateStock">{{ lang.update }}</el-button>
          </template>
        </div>
        <div>
          <div class="flex-container justify-center">
            ...
            <div :style="'background-image: url(' + formEdit.pictures + ')'" class="avatar-tokped text-right">
              <div class="watermark-lazada color-white--bg fl-right flex-container" ></div>
            </div>
            <div class="color-warning font-40 font-bold ml-24">{{ formEdit.pair.stock }}</div>
          </div>
          <div class="mt-24 word-break">
            <span class="font-bold">Update</span> untuk menyamakan stok Lazada dengan stok produk di toko Olseramu
          </div>
        </div>
...
import { updateSingleProductLazada } from '@/api/thirdParty/lazada'
...
export default {
  ...
  methods: {
    ...
    updateStock () {
      ...
      updateSingleProductLazada(data).then(response => {
        this.$message({
          type: 'success',
          message: response.data.data.message
        })
