      ...
      <div class="row equal-cols">
        <div class="col-xs-12 col-sm-6 pr-null">
          <div class="owner-left-side">
            <div class="font-18 pb-16">{{rootLang.required_photo}} (4)</div>
            <el-card class="box-card">
              <el-row>
                <el-col :xs="14" :sm="12" :md="12" :lg="16" :xl="16" align="left">
                  <p class="pt-24 pb-10 word-break"><span class="font-11" style="color: #F56C6C">*</span> {{rootLang.photo_id_card}}</p>
                </el-col>
            ...
            <el-card class="box-card">
              <el-row>
                <el-col :xs="14" :sm="12" :md="12" :lg="16" :xl="16" align="left">
                  <p class="pt-24 pb-10 word-break"> {{rootLang.photo_id_card_couple}} ({{rootLang.if_you_married}})</p>
                </el-col>
                <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                  <el-form-item class="mb-0" align="center">
                    <el-upload
                      ...
                      :before-upload="beforeUpload"
                      :show-file-list="false"
                      :on-progress="handleUploadIdCardCoupleProcess"
                      :on-success="handleUploadIdCardCoupleSuccess"
                      :on-error="handleUploadError"
                      list-type="picture-card"
                      >
                      <img
  ...
  methods: {
    getUserData(){
      userData().then(async response => {
        ...
        this.readIdCard = resp.store.ktp_number !== null ? resp.store.ktp_number.lenght : 0
        this.formData = {
          name: resp.name,
    ...
    handleUploadIdCardCoupleProcess(){
      this.uploadingIdCouple = true
    },
    handleUploadIdCardCoupleSuccess(response, file, fileList) {
    ...
    checkValidateOwner(){
      let validate = false
      if(this.formData.fileIdCard !== null && this.formData.fileFamilyRegister !== null && 
        this.formData.fileNpwp !== null && this.formData.id_card_number.length === 16 &&
        this.formData.address && this.formData.phone_number && this.formData.gender){
        validate = true
      }
      return validate;
    }
