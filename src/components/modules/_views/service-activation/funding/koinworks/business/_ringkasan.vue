          ...
          <template>
            ...
            <div class="like-table-wrapper bd-grey-thin mb-24">
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 300px;" class="lh-2">{{rootLang.your_id_and_company}} ({{rootLang.can_more_than1}})</div>
                  <div class="text-right" v-if="ringkasan.owner.fileIdCard !== null">
              ...
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  ...
                  <div class="text-right" v-if="ringkasan.owner.fileFamilyRegister !== null">
              ...
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 300px;" class="lh-2">{{rootLang.photo_sk_menkumhan}}</div>
                  <div class="text-right" v-if="ringkasan.data_usaha.skMenku !== null" >
                    <img :src="ringkasan.data_usaha.skMenku.photo_md" style="max-height: 30px;"/>
                  </div>
                </div>
              </div>
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 300px;" class="lh-2">{{rootLang.deed_of_establishment}}</div>
                  <div class="text-right" v-if="ringkasan.data_usaha.pendirian !== null" >
                    <img :src="ringkasan.data_usaha.pendirian.photo_md" style="max-height: 30px;"/>
                  </div>
                </div>
              </div>
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 300px;" class="lh-2">{{rootLang.deed_of_change}}</div>
                  <div class="text-right" v-if="ringkasan.data_usaha.perubahan !== null" >
                    <img :src="ringkasan.data_usaha.perubahan.photo_md" style="max-height: 30px;"/>
                  </div>
                </div>
              </div>
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 300px;" class="lh-2">{{rootLang.npwp_each_manager}}</div>
                  <div class="text-right" v-if="ringkasan.data_usaha.npwp_manager !== null">
                    <img :src="ringkasan.data_usaha.npwp_manager.photo_md" style="max-height: 30px;"/>
                  </div>
                </div>
              </div>
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 300px;" class="lh-2">{{rootLang.company_documents}}</div>
                  <div class="text-right" v-if="ringkasan.data_usaha.company_doc !== null">
                    <div v-for="(companyFile, keyCompany) in ringkasan.data_usaha.company_doc" :key="keyCompany">
                      <img :src="companyFile.photo_md" style="max-height: 30px;"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="like-table-wrapper--item py-8">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  ...
                  <div class="text-right" v-if="ringkasan.data_usaha.fileBank !== null">
