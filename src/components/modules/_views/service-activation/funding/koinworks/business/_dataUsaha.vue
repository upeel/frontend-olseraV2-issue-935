        ...
        <div class="row equal-cols">
          <div class="col-xs-12 col-sm-6 pr-null">
            <div class="owner-left-side" style="background-color: #F5F5F5;">
              ...
              <el-card class="box-card">
                <el-row>
                  <el-col :xs="14" :sm="12" :md="12" :lg="16" :xl="16" align="left">
                    <p class="pt-24 pb-10 word-break"><span class="font-11" style="color: #F56C6C">*</span> {{rootLang.photo_sk_menkumhan}} ({{rootLang.for_cv_reg_doc}})</p>
                  </el-col>
                  <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                    <el-form-item class="mb-0" align="center">
                      <el-upload
                        v-loading="uploadingMenku"
                        :action="uploadPhotoUrl"
                        :headers="headers"
                        :before-upload="beforeUpload"
                        :show-file-list="false"
                        :on-progress="handleUploadMenkuProcess"
                        :on-success="handleUploadMenkuSuccess"
                        :on-error="handleUploadError"
                        list-type="picture-card"
                        >
                        <img
                          v-if="dataBranch.skMenku !== null"
                          :src="dataBranch.skMenku.photo_md" alt=""
                        >
                  ...
                  <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                    <el-form-item class="mb-0" align="center">
                      <el-upload
                        ...
                        >
                        <img
                          v-if="dataBranch.pendirian !== null"
                          :src="dataBranch.pendirian.photo_md" alt=""
                        >
                  ...
                  <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                    <el-form-item class="mb-0" align="center">
                      <el-upload
                        ...
                        >
                        <img
                          v-if="dataBranch.perubahan !== null"
                          :src="dataBranch.perubahan.photo_md" alt=""
                        >
                        <i v-else class="el-icon-camera"></i>
                      </el-upload>
                    </el-form-item>
              ...
              <el-card class="box-card">
                <el-row>
                  <el-col :xs="14" :sm="12" :md="12" :lg="16" :xl="16" align="left">
                    <p class="pt-24 pb-10 word-break"><span class="font-11" style="color: #F56C6C">*</span> {{rootLang.npwp_each_manager}}</p>
                  </el-col>
                  <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                    <el-form-item class="mb-0" align="center">
                      <el-upload
                        v-loading="uploadingNPWPManagers"
                        :action="uploadPhotoUrl"
                        :headers="headers"
                        :before-upload="beforeUpload"
                        :show-file-list="false"
                        :on-progress="handleUploadNPWPManagerProcess"
                        :on-success="handleUploadNPWPManagerSuccess"
                        :on-error="handleUploadError"
                        list-type="picture-card"
                        >
                        <img
                          v-if="dataBranch.npwp_manager !== null"
                          :src="dataBranch.npwp_manager.photo_md" alt=""
                        >
                        <i v-else class="el-icon-camera"></i>
                      </el-upload>
                    </el-form-item>
              ...
              <el-card class="box-card">
                <el-row>
                  <el-col :xs="14" :sm="12" :md="12" :lg="16" :xl="16" align="left">
                    <p class="pt-24 pb-10 word-break"><span class="font-11" style="color: #F56C6C">*</span> {{rootLang.company_documents}}</p>
                  </el-col>
                  <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                    <el-form-item class="mb-0" align="center">
                      <el-upload
                        ...
                        :before-upload="beforeUpload"
                        :show-file-list="false"
                        :on-progress="handleUploadCompanyDocProcess"
                        :on-success="handleUploadCompanyDocSuccess"
                        :on-error="handleUploadError"
                        list-type="upload-demo"
                        >
                        <div class="loadingUploadMultiple">
                          <loading v-if="uploadingCompanyDoc" 
                            align="center"
                            :active="true"
                            color= '#1bb4e6'
                            loader="spinner"
                      ...
                      <div class="remove-image-area mt-10" v-for="(fileCompany, keySiup) in dataBranch.company_doc" :key="keySiup">
                        <img :src="fileCompany.photo_md" alt="">
                        <div class="remove-image">
                          <span
                            style="position: static; font-size: inherit; color: inherit;"
                            @click="handleRemoveFileCompany(keySiup)"
                          >
                ...
                <el-row>
                  ...
                  <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                    <el-form-item class="mb-0" align="center">
                      ...
                      <div class="remove-image-area mt-10" v-for="(fileBank, keyFile) in dataBranch.fileBank" :key="keyFile">
                        <img :src="fileBank.photo_md" alt="">
                        <div class="remove-image">
                          <span
                            style="position: static; font-size: inherit; color: inherit;"
          ...
          <div class="col-xs-12 col-sm-6 pl-null">
            <div class="owner-right-side" style="background-color: #FFFFFF; padding: 20px;">
              ...
              <el-form-item :label="rootLang.business_age" prop="businessAge">
            ...
            <el-button
              type="success"
              class="visible-lg visible-md visible-sm absolute-bottom btn-block color-koinworks--bg color-koinworks--border"
              style="width: 88%"
              @click="handleNext">
              {{ rootLang.next }}
            </el-button>
            <el-button
              type="success"
              class="visible-xs btn-block color-koinworks--bg color-koinworks--border"
...
export default {
  ...
  data() {
    return{
      uploadingBank: false,
      uploadingMenku: false,
      uploadingPendirian: false,
      uploadingPerubahan: false,
      uploadingNPWPManagers: false,
      uploadingCompanyDoc: false,
      uploadPhotoUrl: '',
      phone_number: '',
      dataBranch: {
        fileBank: null
  ...
  methods: {
    ...
    handleUploadMenkuProcess(){
      this.uploadingMenku = true
    },
    handleUploadMenkuSuccess(response, file, fileList) {
      this.dataBranch.skMenku = response[0]
      this.uploadingMenku = false
    },
    handleUploadPendirianProcess(){
      this.uploadingPendirian = true
    },
    handleUploadPendirianSuccess(response, file, fileList) {
      this.dataBranch.pendirian = response[0]
    ...
    handleUploadPerubahanSuccess(response, file, fileList) {
      this.dataBranch.perubahan = response[0]
      this.uploadingPerubahan = false
    },
    handleUploadNPWPManagerProcess(){
      this.uploadingNPWPManagers = false
    },
    handleUploadNPWPManagerSuccess(response, file, fileList) {
      this.dataBranch.npwp_manager = response[0]
      this.uploadingNPWPManagers = false
    },
    handleUploadCompanyDocProcess(){
      this.uploadingCompanyDoc = false
    },
    handleUploadCompanyDocSuccess(response, file, fileList) {
      var dataFile = this.dataBranch.company_doc ? this.dataBranch.company_doc : []
      this.dataBranch.company_doc = dataFile ? dataFile.concat(response[0]) : dataFile.push(response[0])
      this.uploadingCompanyDoc = false
    },
    handleRemoveFileCompany(keyRemove) {
      this.dataBranch.company_doc.splice(keyRemove, 1)
    },
    ...
    checkValidasi(){
      let validate = false
      if(this.dataBranch.skMenku !== null && this.dataBranch.fileBank !== null &&
        this.dataBranch.pendirian !== null && this.dataBranch.perubahan !== null &&
        this.dataBranch.npwp_manager !== null && this.dataBranch.business_age !== '' &&
        this.dataBranch.fileBank !== null && this.dataBranch.phone_number !== ''){
        validate = true
      }
      return validate;
    }
