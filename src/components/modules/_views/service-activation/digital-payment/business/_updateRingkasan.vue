        ...
        <div class="col-xs-12 col-sm-6">
          <div class="summary-right-side">
            ...
            <div class="like-table-wrapper mb-24">
              ...
              <div class="like-table-wrapper--item">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 120px;">{{rootLang.address}}</div>
            ...
            <div class="like-table-wrapper mb-24">
              <div class="like-table-wrapper--item">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  ...
                  <div class="text-right" style="width: 20px;">
                    <svg-icon v-if="form.dataUsaha.status_location_business && form.dataUsaha.business_type && form.dataUsaha.logo_ewallet" icon-class="status_icon"></svg-icon>
                    <span v-else
                      class="tag-info-circle"  style="
                      font-size: 4px;
                      padding: 9px 5px;
              ...
              <div class="like-table-wrapper--item">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 120px;">{{rootLang.business_form}}</div>
                  <div class="text-right" style="max-width: 300px;">{{rootLang.company}}</div>
                </div>
              </div>
              <div class="like-table-wrapper--item">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 120px;">{{rootLang.business_type}}</div>
                  <div class="text-right" style="max-width: 300px;">{{form.dataUsaha.business_type_name}}</div>
                </div>
              </div>
              <div class="like-table-wrapper--item">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 120px;">{{rootLang.url_id}}</div>
                  <div class="text-right" style="max-width: 300px;">{{form.dataUsaha.url_id}}</div>
                </div>
              </div>
              <div class="like-table-wrapper--item">
                <div class="flex-container flex-container--start flex-container--content-space-between w-fit">
                  <div style="width: 120px;">{{rootLang.store_location}}</div>
...
export default {
  ...
  methods: {
    getRingkasan(){
      ...
      let urlSite = 'activation/service/digital-payment?store_id='+this.dataForm.store_id+'&submit_as=2&submission=4'
