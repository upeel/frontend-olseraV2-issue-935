<template>
  <div class="submit-submision">
    ...
    <data-owner v-show="inTab === 'owner'" :dataForm="individualForm" @change="handleFormData" @next="handleNext"/>
    <data-usaha v-show="inTab === 'company'" :dataForm="individualForm" @change="handleFormData" ref="dataUsaha" @next="handleNext"/>
    <akun-bank v-show="inTab === 'bank'" :dataForm="individualForm" :dataPemilik="form.applicant" @change="handleFormData" @next="handleNext" ref="dataBank"/>
    <ringkasan v-show="inTab === 'summary'" :dataForm="individualForm" :form="this.form" @next="handleApplySubmission"/>
...
export default {
  ...
  name: 'UpdateSubmisionIndividual',
  ...
  methods: {
    ...
    handleNext(tab, data){
      ...
      if(tab === 'company'){
        ...
        this.$refs.dataBank.checkValidateBank()
