        ...
        <div class="col-xs-12 col-sm-5">
          <div class="owner-left-side" style="background-color: #F5F5F5;">
                ...
                <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                  <el-form-item class="mb-0" align="center">
                    <el-upload
                      ...
                      >
                      <img
                        v-if="Object.keys(formData.fileIdCard).length !== 0"
            ...
            <el-card class="box-card">
              <el-row>
                <el-col :xs="14" :sm="12" :md="12" :lg="16" :xl="16" align="left">
                  <p class="pt-24 pb-10 word-break">{{rootLang.photo_taxpayer_number}}</p>
                </el-col>
                <el-col :xs="10" :sm="12" :md="12" :lg="8" :xl="8">
                  <el-form-item class="mb-0" align="center">
                    <el-upload
                      ...
                      :on-error="handleUploadError">
                      <img
                        v-if="Object.keys(formData.fileNpwp).length !== 0"
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item :label="rootLang.id_card_number" prop="id_card_number">
                  <el-input class="input-radius" v-model="formData.id_card_number" type="text" size="small"
              ...
              <el-col :span="12">
                <el-form-item prop="npwp" :label="rootLang.taxpayer_number">
                <el-input class="input-radius" size="small" v-model="formData.npwp" :maxlength="20"
                    onkeydown="return ( event.ctrlKey || event.altKey 
                        || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
                        || (95<event.keyCode && event.keyCode<106)
                        || (event.keyCode==8) || (event.keyCode==9) 
...
export default {
  ...
  methods: {
    handleNext (){
      this.$emit('next', 'branch', {owner: this.formData})
    },
    ...
    handleUploadNpwpSuccess(response, file, fileList) {
      ...
      this.rulesOwner.npwp[0].required = true
