    ...
    <el-dialog
      ...
      <div class="row branchStore py-8" v-for="(branch, key) in form.branchs" :key="key">
        ...
        <div class="col-sm-3 px-12 pt-4" align="right">
            ...
            <svg-icon v-if="branch.status_location_business" class="" icon-class="status_icon" 
      ...
      if(tab === 'branch'){
        let owner = this.form.owner
          ...
          owner.address !== '' && Object.keys(owner.fileIdCard).length !== 0){
            if((Object.keys(owner.fileNpwp).length !== 0 && Object.prototype.toString.call(owner.fileNpwp) === '[object Object]') && 
