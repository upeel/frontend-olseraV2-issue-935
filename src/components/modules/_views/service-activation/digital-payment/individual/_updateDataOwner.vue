        ...
        <div class="col-xs-12 col-sm-7">
          <div class="owner-right-side" style="background-color: #FFFFFF">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item prop="no_npwp" :label="rootLang.taxpayer_number">
...
export default {
  ...
  methods: {
    getDataDiri(){
      ...
      let urlSite = 'activation/service/digital-payment?store_id='+this.dataForm.store_id+'&submit_as=1&submission=1'
