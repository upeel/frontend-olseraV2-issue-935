    ...
    <section class="content income-expense">
      <el-card class="box-card">
        <div slot="header" class="table-handler-flex">
          <h4 class="box-title" style="flex-grow: 1;">{{ lang.add }} {{ lang.expense }}</h4>
          <div>
          ...
          <el-form label-position="left" label-width="120px">
            ...
            <el-form-item :label="lang.transaction_type">
              ...
              <!-- <el-select
                ...
                <el-option
                  :value="0"
                  style="background: #6EBE46; color: #FFFFFF;">
            ...
            <el-form-item :label="lang.transaction_amount">
              <!-- <money
                v-model="formAdd.total"
                class="el-input__inner"
                @change.native="handleCurrency(formAdd.total)"
              /> -->
...
export default {
  ...
  methods: {
    getDefaultTime() {
      this.formAdd.dateOutcome = moment().format('YYYY-MM-DD HH:mm:ss')
    },
    ...
    save() {
      ...
      let data = {
        type: 'E',
        trans_date: this.formAdd.dateOutcome,
