              ...
              <el-checkbox-group
                ...
                <div
                  ...
                  <el-checkbox
                    ...
                    <div class="font-12 color-grey--placeholder">{{ rootLang.discount_type }} : {{ item.promo_type_id }}</div>
                  </el-checkbox>
                </div>
              </el-checkbox-group>
            </div>
...
<script>
import { getDiscountPos, saveCopyDiscount } from '@/api/marketing/discount'
...
export default {
  ...
  methods: {
    getCopyDiscount (item, search) {
      ...
      getDiscountPos(param).then(response => {
