              ...
              <el-checkbox-group
                ...
                <div
                  ...
                  <el-checkbox
                    ...
                    <div class="font-12 color-grey--placeholder">{{ item.title }}</div>
                  </el-checkbox>
                </div>
              </el-checkbox-group>
            </div>
...
<script>
import { getDiscountVoucher, saveCopyDiscount } from '@/api/marketing/discount'
...
export default {
  ...
  methods: {
    getCopyDiscount (item, search) {
      ...
      getDiscountVoucher(param).then(response => {
