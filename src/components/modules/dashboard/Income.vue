<template>
  <div class="flex-container-same-height no-flex-sm mb-16 bg-white box-shadow radius-10">
    <!-- <div class="dashboard-banner-section dashboard-banner-section--income">
      <svg-icon icon-class="trending-up" />
      <span style="font-size: 18px">{{ lang.income }}</span>
    </div> -->

    <div class="dashboard-content-section">
      <div class="flex-container">
        <svg-icon icon-class="trending-up" style="font-size: 25px; margin-right: 16px"/>
        <span style="font-size: 16px; font-weight: bold; margin-right: auto;">{{ lang.income }}</span>
